...
function ScanParticles({ scanning }: { scanning: boolean }) {
...
function DocGrid({ scanning }: { scanning: boolean }) {
...
export default function ScanAnimation({ scanning, className }: ScanAnimationProps) {
  return (
