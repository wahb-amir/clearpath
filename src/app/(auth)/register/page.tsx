  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h1 className="text-2xl font-semibold text-slate-100 mb-2">Create an account</h1>
        <p className="text-slate-400 text-sm">Join ClearPath to start making sense of your documents</p>
      </div>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex items-start gap-3 py-2">
          <input type="checkbox" id="terms" className="mt-1 rounded bg-slate-900 border-slate-700 text-blue-500 focus:ring-blue-500 focus:ring-offset-slate-900" />
          <label htmlFor="terms" className="text-sm text-slate-400 leading-relaxed">
            I agree to the <a href="#" className="text-blue-400 hover:text-blue-300">Terms of Service</a> and <a href="#" className="text-blue-400 hover:text-blue-300">Privacy Policy</a>. I understand that ClearPath uses AI and I should always verify critical information.
          </label>
        </div>
