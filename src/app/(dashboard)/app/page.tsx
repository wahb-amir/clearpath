...
export default function AppPage() {
  const [currentDoc, setCurrentDoc] = useState<SampleDocument | null>(null);
  const [analyzing, setAnalyzing] = useState(false);

  const handleAnalyze = (doc: SampleDocument) => {
    setAnalyzing(true);
    setCurrentDoc(null);
            ...
            >
              ...
              {currentDoc && (
                ...
                >
                  ...
                  />
                  <span style={{ color: "hsl(142, 71%, 60%)", fontSize: "0.78rem", fontWeight: 600 }}>
