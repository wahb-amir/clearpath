    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "1rem", flexWrap: "wrap", gap: "0.75rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.625rem" }}>
          ...
          <div>
            <div style={{ color: "hsl(220, 10%, 55%)", fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.2rem" }}>
              AI Summary
            </div>
            <div style={{ color: "hsl(220, 20%, 90%)", fontWeight: 700, fontSize: "1rem", fontFamily: "Outfit, sans-serif", letterSpacing: "-0.01em" }}>
              {result.title}
            </div>
          </div>
        </div>
      ...
      >
        <p style={{ color: "hsl(220, 12%, 78%)", fontSize: "0.9rem", lineHeight: 1.75, margin: 0 }}>
          {result.summary}
        </p>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", flexWrap: "wrap" }}>
        ...
        >
          ...
          <span style={{ color: "hsl(191, 100%, 50%)", fontSize: "0.72rem", fontWeight: 500 }}>
