...
export default function QuestionsCard({ result }: QuestionsCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <p style={{ color: "hsl(220, 8%, 50%)", fontSize: "0.8rem", marginBottom: "1rem", lineHeight: 1.6 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
        {result.questions.map((question, i) => (
          <motion.div
            ...
            whileHover={{ x: 4, backgroundColor: "hsla(199, 89%, 48%, 0.06)" }}
            style={{
              display: "flex",
          ...
          >
            ...
            <p style={{ color: "hsl(220, 12%, 75%)", fontSize: "0.875rem", lineHeight: 1.55, margin: 0, flex: 1 }}>
              {question}
            </p>
            <ChevronRight size={14} color="hsl(220, 10%, 35%)" style={{ flexShrink: 0, marginTop: "3px" }} />
          </motion.div>
        ))}
      </div>
      ...
      >
        ...
        <p style={{ color: "hsl(199, 89%, 65%)", fontSize: "0.75rem", margin: 0, lineHeight: 1.5 }}>
