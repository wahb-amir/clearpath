        ...
        >
            ...
            {navLinks.map((link) => (
              <Link key={link.href} href={link.href} style={{ textDecoration: "none" }}>
                <motion.span
                  ...
                  onMouseEnter={(e) => {
                    (e.target as HTMLElement).style.color = "hsl(220, 20%, 95%)";
                    (e.target as HTMLElement).style.background = "hsla(222, 35%, 12%, 0.8)";
                  }}
                  onMouseLeave={(e) => {
                    (e.target as HTMLElement).style.color = "hsl(220, 10%, 65%)";
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <Link href="/app" style={{ textDecoration: "none" }} className="hidden md:block">
              <motion.button
                whileHover={{ scale: 1.03, boxShadow: "0 8px 30px hsla(221, 83%, 53%, 0.35)" }}
                whileTap={{ scale: 0.97 }}
                style={{
