    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Here&apos;s what a ClearPath analysis looks like for a school
            attendance warning.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow:
              "0 40px 120px hsla(221, 83%, 53%, 0.1), 0 0 0 1px hsla(222, 25%, 16%, 0.5)",
          }}
        >
          {/* Browser chrome */}
          <div
          ...
          >
            <div style={{ display: "flex", gap: "0.375rem" }}>
              {["hsl(0,80%,60%)", "hsl(38,92%,55%)", "hsl(142,71%,50%)"].map(
                (c, i) => (
                  <div
                    key={i}
                    style={{
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  style={{ color: "hsl(142, 71%, 60%)", fontSize: "0.75rem" }}
                >
                  High confidence · Verify deadline with school
                </span>
              </div>
            </div>
          </div>
        ...
        >
          <Link href="/app" style={{ textDecoration: "none" }}>
            <motion.button
              whileHover={{
                scale: 1.04,
                boxShadow: "0 12px 40px hsla(221, 83%, 53%, 0.35)",
              }}
              whileTap={{ scale: 0.97 }}
              style={{
                display: "inline-flex",
