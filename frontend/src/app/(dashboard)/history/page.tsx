...
import { Search, Filter, MoreHorizontal, FileText, Clock, AlertTriangle, CheckCircle, ExternalLink, Bookmark } from "lucide-react";
...
export default function HistoryPage() {
  ...
  const filteredItems = mockHistoryItems.filter((item) => {
    ...
    const matchesType = filterType === "all" || item.urgency === filterType;
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-display font-bold text-slate-100 mb-2">Document History</h1>
        <p className="text-slate-400">View and manage all your previously analyzed documents.</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <select
            ...
            className="bg-slate-900 border border-slate-800 rounded-xl py-2.5 px-4 text-sm text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 appearance-none"
          >
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500 mb-3">
                      <span className="flex items-center gap-1"><FileText size={12}/> {item.type}</span>
                ...
                <div className="flex md:flex-col items-center md:items-end justify-between gap-3 min-w-[140px]">
                  ...
                  <div className="flex items-center gap-2">
                    <button className={`p-2 rounded-lg transition-colors ${item.saved ? 'text-blue-400 bg-blue-900/20' : 'text-slate-500 hover:text-slate-300 hover:bg-slate-800'}`}>
